...
defineRouteMeta({
  openAPI: {
    ...
    description:
      "Replaces all fields and the full feature set of an existing filament. Features not listed in featureIds are removed.",
