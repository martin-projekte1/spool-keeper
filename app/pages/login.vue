  ...
  <div
    ...
    <div
      ...
      <div class="space-y-2">
        ...
        <h1 class="text-3xl font-bold tracking-tight text-neutral-900 dark:text-white">Spool Keeper</h1>
        <p class="text-neutral-500 dark:text-neutral-400">Filament Inventory Manager</p>
      </div>

      <div v-if="error" class="p-3 rounded-xl bg-red-500/10 border border-red-500/20">
        <p v-if="error === 'unauthorized'" class="text-red-600 dark:text-red-400 text-sm font-medium">
